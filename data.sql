...
DROP TABLE IF EXISTS companies ON DELETE CASCADE;
DROP TABLE IF EXISTS industries ON DELETE CASCADE;
DROP TABLE IF EXISTS industries_companies ON DELETE CASCADE;
